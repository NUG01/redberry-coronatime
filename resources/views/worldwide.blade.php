        ...
        <div class="flex justify-between mt-[4rem]">
            <div class="w-[31%] h-[31rem] bg-[rgba(32,43,243,0.08)] rounded-[16px] flex items-center justify-center">
                <div class="flex flex-col items-center justify-center gap-[1.6rem]">
                    ...
                    <p class="font-medium text-[2rem] mt-[1rem]">New Cases</p>
                    <p class="font-black text-[4rem] text-[#2029F3]">715,523</p>
                </div>
            </div>
            <div class="w-[31%] h-[31rem] bg-[rgba(15,186,103,0.08)] rounded-[16px] flex items-center justify-center">
                <div class="flex flex-col items-center justify-center gap-[1.6rem]">
                    ...
                    <p class="font-medium text-[2rem] mt-[1rem]">Recovered</p>
                    <p class="font-black text-[4rem] text-[#0FBA68]">72,005</p>
                </div>
            </div>
            <div class="w-[31%] h-[31rem] bg-[rgba(234,214,33,0.08)] rounded-[16px] flex items-center justify-center">
                <div class="flex flex-col items-center justify-center gap-[1.6rem]">
                    ...
                    <p class="font-medium text-[2rem] mt-[1rem]">Death</p>
                    <p class="font-black text-[4rem] text-[#EAD621]">8,332</p>
                </div>
            </div>
        </div>
        <div class="h-[30rem] mt-[12rem] rounded-[16px] flex items-center justify-center"
            ...
            <div class="flex flex-col items-center justify-center gap-[1.6rem]">
                ...
                <form class="w-[42rem] h-[6.4rem] bg-white mt-[2.4rem] rounded-[3.2rem] flex items-center justify-between">
                    <div class="flex gap-[1.6rem] ml-[3.2rem]"><svg width="20" height="20" viewBox="0 0 20 20"
