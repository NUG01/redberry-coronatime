...
@section('content')
    ...
    <body>
        <div>
            <div class="ml-[10%] mt-[4rem] inline-block">
                ...
                <form>
                    ...
                    <div class="flex mb-[2.5rem] justify-between">
                        <div class="flex gap-[0.8rem]">
                            <input type="checkbox" name="checkbox" id="checkbox"
                                class="border border-[#E6E6E7] border-solid w-[20px] h-[20px] rounded cursor-pointer">
                    ...
                    <button type="submit"
                        class="mb-[2.5rem] h-[6rem] w-full flex items-center justify-center bg-[#0FBA68] font-black text-[1.6rem] text-white rounded-xl">Log
                        In</button>
                    <div class="flex justify-center gap-[0.4rem] text-[1.6rem]">
                        <p class="text-[#808189] font-normal">Don't have an account?</p> <span
