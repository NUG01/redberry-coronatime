...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        ...
        .button {
            ...
            color: #fff !important;
            background-color: #0FBA68 !important;
...
<body
    ...
    <span class="preheader"
        style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Newsletter
        subscription
    </span>
                    ...
                    <tr>
                        <td class="email-body" width="750" cellpadding="0" cellspacing="0"
                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                style="width: 630px; -premailer-width: 630px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF; margin: 0 auto; padding: 0;"
                                bgcolor="#FFFFFF">
                                <!-- Body content -->
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <div class="f-fallback" style="text-align:center;">
                                            <img style="width:85%; margin:0 auto;"
                                                src="{{ $message->embed(public_path() . '/images/emailConf.png') }}">
                                            <!-- Action -->
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                    <p
                                                                        style="font-size:25px;font-weight:900;font-family:'Inter',sans-serif;margin-bottom:16px !important;color:#010414;">
                                                                        Thank you!</p>
                                                                    <p
                                                                    ...
                                                                    <a href="{{ getenv('APP_URL') }}/" target="_blank"
                                                                        ...
                                                                        <span class="ninja"
                                                                            style="font-family:'Inter',sans-serif;">Visit
                                                                            CoronaTime</span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
